...
class SimplifyPermissionProvider implements PermissionProvider
{
  ...
  public static $custom_permissions = array();
    public static $custom_css_path = null;
    public static $custom_js_path = null;
    public static $removeEnabled = true;
  
  //list of extended default permissions, with logical groups 
  public static $default_permissions = array(
          "Global" => array(
   ...
   * Stub constructor
   */
  public function SimplifyPermissionProvider()
  {
  }
     ...
     * */
  public function setCustomPermissions($customPermissions, $customCSSPath, $customJSPath)
  {
